...
public class CommonHelper {
	...
	private static int getWalkableBlockIndex(World world, int x, int y, int z, int max, int min) {
	...
	public static boolean isSolidBlock(World world, int x, int y, int z){
		return world.blockExists(x, y, z) &&
				world.getBlock(x, y, z).getCollisionBoundingBoxFromPool(world, x, y, z) != null;
	}
