...
public class ModelWaypoint extends ModelBase
{
	...
	public void renderArrow(Entity var1, float f, float g, float h, float i, float j, float k) {
		 this.arrow.render(k * 1.5F);
	}

	public void renderBase(Entity var1, float f, float g, float h, float i, float j, float k) {
